...
data class Room(
    ...
    val rect: Rect = Rect.calculateRect(lat,lon,size)
...
data class Rect(public val lat_0:Double = 1.0,public val lon_0:Double = 1.0,public val lat_1:Double = 1.0,public val lon_1:Double = 1.0){
    companion object {
